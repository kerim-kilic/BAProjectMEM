...
map_vol_1 <- ggplot(Spain) + geom_sf(fill = "#4ED09A", color = "#000000") +
  geom_point(data = Revenue_region, aes(x = Longitude, y = Latitude, size = Volume), color = "#124C6F") +
...
map_sales_2 <- ggplot(Spain) + geom_sf(fill = "#4ED09A", color = "#000000") + 
  geom_point(data = Revenue_region, aes(x = Longitude, y = Latitude, size = sales_per_capita), color = "#124C6F") + 
  theme(axis.title.x = element_text(size = 10),
        axis.title.y = element_text(size = 10),
        legend.title =  element_text(size = 8),
        legend.text = element_text(size = 8),
