...
orders_retailers_capitals <- orders_retailers_capitals %>% distinct(
  id_establishment,material, date ,quantity, price, Capital, Latitude, Longitude, Autonomous_community ,Population_community,Population, Beer_consumption)
...
Revenue_Autonomous_community <- Revenue_Autonomous_community %>%
  mutate(Sales_per_capita = Sales / Population_community, Volume_per_capita = Volume / Population_community)
