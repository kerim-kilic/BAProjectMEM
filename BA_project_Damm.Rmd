...
```
The plot above shows the number of repeat transactions for customers in total. As can be observed, the repeat transactions were down during 2020 lockdown period, which also influenced the prediction model. Nonetheless, the Pareto curve seems stable. 
