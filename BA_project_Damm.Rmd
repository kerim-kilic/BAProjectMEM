...
Revenue_region <- orders_retailers_capitals %>% group_by(Capital) %>% summarise(Sales = sum(Revenue), Habitantes = mean(Habitantes), Longitude = mean(Longitud), Latitude = mean(Latitud))
